  ...
  (function(module, exports, __webpack_require__) {
    ...
    var Recorder = (function() {
      ...
      Recorder.prototype._getRecorderWorkerUrl = function() {
        ...
        return getBlobUrl(new Blob([this._getFunctionBody(RecorderWorker_1.default.createRecorderWorker())], {
    ...
    var StreamClient = (function() {
      ...
      StreamClient.prototype.init = function() {
        ...
        if (navigator.getUserMedia) {
          navigator.getUserMedia({
            audio: true
          }, this.startUserMedia.bind(this, this.onInit), function(e) {
